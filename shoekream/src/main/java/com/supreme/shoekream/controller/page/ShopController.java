...
//    public ModelAndView shop_search() { return new ModelAndView("/shop/shop_search"); }
    ...
    public String products(
            ...
            @PageableDefault(size = 10, sort = "releaseDate", direction = Sort.Direction.DESC) Pageable pageable, ModelMap map
    ) {

        Page<Product> products = shopApiLogicService.searchProduct(searchType, searchValue, pageable); // response 타입 객체로 저장 Page에 저장
