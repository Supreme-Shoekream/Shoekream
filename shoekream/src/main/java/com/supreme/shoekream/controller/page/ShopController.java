...
//            @RequestParam(required = false) SearchType searchType,
//            @RequestParam(required = false)String searchValue,
//            @PageableDefault(size = 40, sort = "brand", direction = Sort.Direction.DESC) Pageable pageable, ModelMap map
//    ){
//        Page<Product> products = shopApiLogicService.searchProduct(searchType, searchValue, pageable);
////        List<Integer> barNumbers = paginationService.getPaginationBarNumbers(pageable.getPageNumber(), articles.getTotalPages());
//        List<String> brand = shopApiLogicService.getBrand();
//
//        map.addAttribute("products", products);
//        map.addAttribute("searchTypes", SearchType.values());
////        map.addAttribute("paginationBarNumbers", barNumbers);
