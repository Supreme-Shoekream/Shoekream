...
public class Sell extends BaseEntity implements Auditable {
    @Id @GeneratedValue(strategy = GenerationType.IDENTITY) Long idx; // 번호
    private Long product_idx; // 판매 상품 번호
    private Long member_idx; // 판매 회원 번호
    ...
    private Long account_idx; // 계좌 번호
    private Long address_idx; // 주소 번호
//    private LocalDateTime reg_date; // 판매 날짜
